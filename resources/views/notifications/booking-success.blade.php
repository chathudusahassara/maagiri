...
<section id="header">
                    ...
                    <div class="logo d-none d-sm-block"><a href="{{ url('/') }}"><img src="{{ url('images/logo_desktop.svg') }}" data-color="violet" alt="Maagiri Logo"></a></div>
                        <div class="logo-mobi d-block d-sm-none"><a href="{{ url('/') }}"><img src="{{ url('images/logo_mobile.svg') }}" data-color="violet" alt="Maagiri Logo"></a></div>
                    </div>
</section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="text-wrapper-main" style="padding-top:100px;">
                                    ...
                                    The enquiry has been submitted. We will get back to you shortly.
                                    </div>
